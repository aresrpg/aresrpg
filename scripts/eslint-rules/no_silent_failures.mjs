...
// scripts/eslint-rules/no_silent_failures.mjs — THE SILENT-FAILURE TRIPWIRE (AGENTS.md L-D1,
  ...
  meta: {
    ...
    messages: {
      silentFailure:
        ...
        'Instruments THROW, never coerce (AGENTS.md L-D1): re-throw it, return it as data ' +
