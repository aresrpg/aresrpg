...
//
// core_replay.js — §⑤ THE REPLAY HARNESS. The input log IS the state (consensus §Unanimous):
...
import { empty_core_state } from './core_state.js'
import { ingest } from './core_ingest.js'
 ...
 * @param {import('./core_state.js').CoreState} [seed] an initial core (defaults to a fresh one)
 ...
 * @returns {{ state: import('./core_state.js').CoreState, envelopes: number, final_index: { version: number, ordinal: number },
