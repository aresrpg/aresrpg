...
// RED-FIRST (TRANSPORT RULING): neither worn cosmetics nor pet companions are trusted over WebRTC — both load
// from the rpc directly. Proves the peer cache resolves a peer's hat/cloak AND equipped pet from the SAME
...
// every stale id, respects the TTL, and never latches an absence permanently. No p2p payload appears anywhere
