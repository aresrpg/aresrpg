...
export function MapDrawer() {
  ...
  useEffect(() => {
    ...
    // deps (react-hooks/exhaustive-deps is not wired in this repo — the directive was inert): center_on_player/bump read live refs (view_ref/player_ref) and would rerun this seed-triggered resample on every render if listed
  }, [seed])
  ...
  useEffect(() => {
    ...
    // deps (react-hooks/exhaustive-deps is not wired in this repo — the directive was inert): min_zoom_for/clamp_view read view_ref live; listing them would reattach the wheel listener every render for no behavior change
  }, [bump])
