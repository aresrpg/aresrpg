...
// diorama create this layer; it renders every presence entry (visible_characters — fed by the p2p transport's
...
export function create_remote_players(engine, world_canvas = null) {
  ...
  // Identity comes from the chain read the presence fold requests on a peer's first sighting.
