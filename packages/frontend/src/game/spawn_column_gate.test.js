...
// MISSING-ARTIFACT (#117): spawn_column_gate.js imports @aresrpg/engine3/player, whose character_controller.js
...
const { read_spawn_column_gate } = SENSHI_MALE_GLB_AVAILABLE ? await import('./spawn_column_gate.js') : {}

const open_column = (surface_y) => (_x, y) => (y <= surface_y ? 3 : 0)

describe.skipIf(!SENSHI_MALE_GLB_AVAILABLE)('world-join spawn-column gate', () => {
