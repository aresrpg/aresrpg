...
export const TelegramCard = ({ copy }: Readonly<{ copy: AppCopy }>) => (
  ...
  >
    <Send
      aria-hidden="true"
      className="shrink-0 text-[#229ed9] drop-shadow-[0_0_6px_rgba(34,158,217,0.6)] transition-all group-hover:drop-shadow-[0_0_10px_rgba(34,158,217,0.9)]"
      size={14}
    />
    <span className="text-[10px] font-semibold tracking-[0.2em]">{copy.join_telegram}</span>
  </a>
)
