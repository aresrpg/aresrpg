...
/**
 * Destroy an existing world scene, then leave its module-global p2p room once the lazy chunk is ready.
 * The caller-supplied guard prevents a stale import resolution from tearing down a newer scene's room.
 * A null scene is the cold-login path: it deliberately performs no import and therefore cannot join.
 *
