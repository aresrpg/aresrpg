...
const spies = [
  ...
  spyOn(lobby_room, 'set_room_party').mockImplementation((party_id) => synced.push(party_id)),
  spyOn(lobby_room, 'publish_room_state').mockImplementation((state) => published.push(state)),
