...
// engage_timing.js and fast_travel_timing.js keep their own bespoke recorders — engage's stages bind to a
// Transaction object and then to a fight id that does not exist until finality, and fast travel's leg set
// varies with the destination world, neither of which a click-time key models — but both share these
// primitives, so the measuring code still has one home.
