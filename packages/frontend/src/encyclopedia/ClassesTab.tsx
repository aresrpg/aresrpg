...
import { EncyclopediaBrowser } from './components.tsx'
        ...
        detail && (
          <div className="min-h-0 flex-1 overflow-y-auto p-4 pt-14">
            <div className="mx-auto flex max-w-6xl flex-col gap-4">
                        ...
                        <span className="flex flex-wrap gap-1.5">
                          {characteristic_ladders[classe][stat].map((step, index, rows) => {
                            ...
                            return (
                              ...
                              >
                                {text(
                                  cap === undefined ? 'characteristic_cost_unlimited' : 'characteristic_cost_band',
                                  {
                                    cost: step.cost,
                                    gain: step.gain,
                                    cap: cap ?? 0,
              ...
              <div className="enc-class-spells flex min-h-[420px] border border-border bg-black/10">
                      ...
                      >
                        {spell_icon(row.classe, row.name) && (
                          <img
                            ...
                            src={spell_icon(row.classe, row.name)!}
                          />
                        )}
                ...
                <div className="min-w-0 flex-1 p-5">
                  {spell && (
                    <SpellCard
                      display_name={display_spell_name(spell.name)}
                      key={spell.name}
                      spell={spell}
                      text={text}
                    />
