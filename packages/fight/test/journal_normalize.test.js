...
import { content_key, journal_key, normalize_journal_page, normalize_receipt } from '../src/journal_normalize.js'

const load = (name) =>
  JSON.parse(readFileSync(fileURLToPath(new URL(`./fixtures/journal/${name}`, import.meta.url)), 'utf8'))
