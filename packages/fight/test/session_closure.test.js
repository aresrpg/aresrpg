...
const { evaluate_trace } = PACING_ENVELOPES_AVAILABLE
  ? await import('../../../test/gold/specs_anchor/pacing_envelopes.ts')
  : { evaluate_trace: undefined }
...
describe.skipIf(!PACING_ENVELOPES_AVAILABLE)(
  'full session closure — the session ends with the FightResult OPENED, not just settled',
  () => {
