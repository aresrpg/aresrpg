...
public fun seat(
  ...
  // §387: no weapon lines + no shape category for PvP seats (the arena keeps the family fallback + the 1-cell strike
  // until it adopts the weapon-line seat path) — joiner_category = none.
