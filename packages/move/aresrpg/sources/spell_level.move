...
///     `min_char_level` (monotone; L6 = y16+100 — enforced at mint). Read from the template.
...
public fun raise_spell_level(
  ...
  character_link::y5(chr, cost, version);
  character_link::y4(chr, spell_id, target, version);
}
