...
fun the_commitment_byte_selects_the_mob_derivation() {
  ...
  let (mem_ids, _tm, _mm, mem_x, mem_z, _sm, _gm, _pm) = zone_comp::z45(&w, zx, zy, seed, TEAM_BOUND);
  ...
  let (grid_ids, _t3, grid_x, grid_z, _s3, _g3) = zone_comp::z44(&w, zx, zy, seed, TEAM_BOUND);
...
fun the_commitment_byte_selects_the_resource_derivation() {
  ...
  let (mem_ids, _tm, mem_x, mem_z, _jm, _rm) = zone_comp::z46(&w, zx, zy, seed);
  ...
  zones::set_lattice_commitment_for_testing(&mut w, zx, zy, TEAM_BOUND);
  let (grid_ids, _t3, grid_x, grid_z, _j3, _r3) = zone_comp::z46(&w, zx, zy, seed);
...
fun the_view_getters_follow_the_commitment_byte() {
  ...
  let (_i3, _t3, _m3, mx3, mz3, _s3, _g3, _p3) = zone_comp::z45(&w, zx, zy, seed, 1);
  ...
  let (_i2, _t2, grid_x, grid_z, _s2, _g2) = zone_comp::z44(&w, zx, zy, seed, 1);
