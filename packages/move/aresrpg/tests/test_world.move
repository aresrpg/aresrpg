...
/// must already be whitelisted. A stackable category (resource/consumable) rides the `z38` door; every
...
/// Mint a RAW item from `template_id` and z503 it onto `who`'s character `cid` as an EQUIPPED item DF (bypasses
