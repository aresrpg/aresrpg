...
import { create_chunk_record, get_occupancy_bit, local_index, set_occupancy_bit } from '../../src/chunks/format.js'
...
import { LEAF_SPRITE_IDS, SNOW_ID } from '../../src/mesh/leaf_sprites.js'
 ...
 * @param {import('../../src/mesh/mesher.js').NeighborHalos} [halos] boundary lookups the mesh used, if any
 */
 ...
 * @param {import('../../src/chunks/format.js').ChunkRecord} chunk
 * @param {{ quad_buffer: Uint32Array, quad_count: number }} mesh
 * @param {import('../../src/mesh/mesher.js').NeighborHalos} [halos]
 */
...
describe('mesh_chunk: +y surface coverage invariant (no striped/missing top faces)', () => {
  ...
  test('real world chunk (0,4,0) solid surface: exact coverage, with and without halos', () => {
    ...
    /** @type {Map<string, import('../../src/chunks/format.js').ChunkRecord>} */
    const cache = new Map()
