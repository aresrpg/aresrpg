...
import { create_chunk_record, local_index, pack_light, set_occupancy_bit } from '../../src/chunks/format.js'
...
import { generate_test_chunk } from '../../src/chunks/test_gen.js'
import { build_neighbor_halos, coord_key } from '../../src/chunks/store.js'
import { mesh_chunk } from '../../src/mesh/mesher.js'
import { decode_quad } from '../../src/mesh/quad_buffer.js'
import { set_leaf_cubes_debug, LEAF_SPRITE_IDS, leaf_normal_index } from '../../src/mesh/leaf_sprites.js'
 ...
 * @returns {import('../../src/chunks/format.js').ChunkRecord}
 */
...
describe('mesh_chunk: cross-shape foliage (grass_tuft) emits faces 6/7 without culling below', () => {
  ...
  const ord = (/** @type {import('../../src/mesh/quad_buffer.js').QuadFields} */ q) => q.ao[0] | (q.ao[1] << 2)
 ...
 * @param {import('../../src/mesh/quad_buffer.js').QuadFields[]} quads
 * @param {number} x
 * @param {number} y
 * @param {number} z
 * @param {number} face
 * @returns {import('../../src/mesh/quad_buffer.js').QuadFields | undefined}
 */
