...
import { get_sun_light, local_index } from '../../src/chunks/format.js'
import {
  generate_cave_room,
  generate_cave_room as d213_gen,
  generate_cave_room as d232_gen,
  resolve_cave_config,
  DEFAULT_CAVE_CONFIG,
  FLAT_REGION_X,
  FLAT_REGION_Z,
} from '../../src/gen/cave_room.js'
...
function hash_room_blocks(/** @type {import('../../src/gen/cave_room.js').CaveRoom} */ room) {
...
describe('determinism: (config, seed) fully determines the block set', () => {
  ...
  test('gen source is integer-only (no transcendentals — determinism law §3.7)', () => {
    const src = readFileSync(fileURLToPath(new URL('../../src/gen/cave_room.js', import.meta.url)), 'utf8')
