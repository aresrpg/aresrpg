...
import { create_gen_context, generate_column, biome_at, anchor_surface } from '../../../src/gen/column_gen.js'
...
import { WORLD_CONFIGS, WORLD_NAMES } from '../../../src/config/worlds/index.js'
import { set_gen_config } from '../../../src/gen/world_gen.js'
import { CHUNKS_PER_COLUMN } from '../../../src/config/world_config.js'
import { create_region_context, region_profile, IDENTITY_PROFILE } from '../../../src/gen/stages/regions.js'
...
describe('S-25 region layer — integration (massif world)', () => {
  const disabled = /** @type {import('../../../src/config/world_gen_config.js').WorldGenConfig} */ ({
