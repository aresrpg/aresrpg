...
import { CHUNK_SIZE, SEA_LEVEL } from '../../src/config/world_config.js'
import { local_index, column_index } from '../../src/chunks/format.js'
import { get_block_by_name } from '../../src/config/block_registry.js'
import { generate_world_chunk, world_surface_y } from '../../src/gen/world_gen.js'
...
describe('world_gen transcendental ban (§3.7) — files added by this workstream', () => {
  ...
  for (const file of ['world_gen.js', 'surface_decorator.js']) {
    test(`${file} is transcendental-free`, () => {
      const path = fileURLToPath(new URL(`../../src/gen/${file}`, import.meta.url))
