...
import { map_block_name, mapping_coverage } from '../../../src/gen/schematics/registry_map.js'
import {
  load_schematic,
  load_schematic_set,
  load_all_schematics,
  bundle_block_names,
} from '../../../src/gen/schematics/loader.js'
...
describe('registry_map keyword ruleset', () => {
  /** @type {[string, number, import('../../../src/gen/schematics/registry_map.js').MappingTier][]} */
  const cases = [
