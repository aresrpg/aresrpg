...
import { WORLD_CONFIGS, WORLD_NAMES, world_config_for_biome } from '../../src/config/worlds/index.js'
  ...
  test('retuning the erosion→amplitude spline moves terrain', () => {
    const flat = {
      ...
      splines: {
        ...
        erosion_to_amplitude: /** @type {import('../../src/config/world_gen_config.js').SplineKnot[]} */ ([
          [0, 8],
          [1, 3],
        ]),
      },
