...
import { DEFAULT_GRADE, grade_rgb_lowfreq, luma } from '../../src/render/grading.js'
import {
  CHANNELS,
  CELL_LAYER_ORDER,
  CORNER_RADIUS,
  ...
  trap_blob_alpha,
} from '../../src/tactical/board_highlights.js'
import { TRAP_SPIKE_COLOR } from '../../src/tactical/board_highlight_materials.js'
import { CELL_FLOOR } from '../../src/tactical/board.js'
import { PAVING_TONE_DOMINANT } from '../../src/tactical/board_surface.js'
...
describe('⑬ trap marker renders ABOVE the MP-range blob wash', () => {
  ...
  test('the tactical facade supplies the live camera reversed-depth flag', async () => {
    const src = await Bun.file(new URL('../../src/tactical/index.js', import.meta.url)).text()
