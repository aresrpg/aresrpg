...
import * as real_overlay from '../../src/render/board_highlight_overlay_pass.js'
...
mock.module('../../src/render/board_highlight_overlay_pass.js', () => ({
  ...real_overlay,
  create_highlight_overlay: spy_create_highlight_overlay,
}))
afterAll(() => mock.restore())

const { create_post_stack } = await import('../../src/render/lighting/post_stack.js')
