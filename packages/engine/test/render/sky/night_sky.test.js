...
import { SKY_NIGHT, luminance } from '../../../src/render/sky/sky_node.js'
...
describe('stars — luminance discipline (the bloom-knee law)', () => {
  ...
  test('the SHIPPED config (NIGHT_SKY_LIVE) stays under the 2.05 bloom knee', () => {
    ...
    const base = luminance(
      /** @type {import('../../../src/render/sky/sky_node.js').SkyPalette} */ (cfg.base_palette).horizon
    )
