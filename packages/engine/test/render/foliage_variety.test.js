...
import { BLOCK_REGISTRY } from '../../src/config/block_registry.js'
import {
  foliage_cull_margin,
  leaf_tilt_angle,
  LEAF_TILT_MAX,
  pair_cross_angle,
  LEAF_CROSS_JITTER,
} from '../../src/render/terrain_flora.js'
import { canopy_variety_offsets, CANOPY_VARIETY } from '../../src/render/terrain_leaf.js'
