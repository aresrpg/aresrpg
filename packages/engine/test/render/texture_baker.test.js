...
import {
  ...
  atlas_layer_count,
  MAX_ATLAS_LAYERS,
} from '../../src/render/texture_baker.js'
...
/**
 * @param {import('../../src/render/texture_baker.js').BakeResult} res
 * @param {number} layer
 ...
 * @type {Map<string, import('../../src/render/texture_baker.js').BakeResult>}
 */
const bakes = new Map()
/**
 * @param {number} seed
 * @param {number} [max_layers]
 * @returns {import('../../src/render/texture_baker.js').BakeResult}
 */
...
describe('determinism', () => {
  ...
  test('variant layers of one recipe are byte-stable across runs AND decorrelated from each other', () => {
    ...
    /** @param {import('../../src/render/texture_baker.js').BakeResult} r @param {number} layer */
