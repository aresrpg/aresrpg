...
import { create_board_highlights } from '../../src/tactical/board_highlights.js'
import {
...
describe('renderer wiring — the router is told the render path exactly once, after the try/catch', () => {
  const renderer_source = readFileSync(new URL('../../src/core/renderer.js', import.meta.url), 'utf8')
