...
import {
  ...
  integrate_slices,
  slice_dist,
} from '../../../src/render/lighting/froxels.js'
 ...
 * @param {import('../../../src/render/lighting/froxels.js').FroxelSlice[]} slices @param {number} micro sub-steps per slice
...
/** deterministic pseudo-random slice grid. @param {number} n @returns {import('../../../src/render/lighting/froxels.js').FroxelSlice[]} */
function make_slices(n) {
  /** @type {import('../../../src/render/lighting/froxels.js').FroxelSlice[]} */
  const out = []
  let s = 0x2545f491
