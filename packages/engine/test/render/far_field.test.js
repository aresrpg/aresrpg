...
import { CELLS_PER_SECTION } from '../../src/lod/section_builder.js'
import { build_section_geometry, create_far_field, mask_texel_index } from '../../src/render/far_field.js'
...
describe('build_section_geometry (voxel L1/L2)', () => {
  ...
  function voxel_mesh() {
    return /** @type {import('../../src/lod/far_voxel_mesher.js').VoxelMesh} */ ({
      kind: 'voxel',
      level: 1,
      lod_scale: 1,
      origin_x: 0,
