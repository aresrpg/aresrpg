...
import { CHARACTER_COLLIDER_HEIGHT, CHARACTER_RADIUS } from '../../src/config/world_config.js'
import { box_overlaps_solid, eject_from_solid } from '../../src/player/collision.js'

const R = CHARACTER_RADIUS
const H = CHARACTER_COLLIDER_HEIGHT
const buried = (
  /** @type {import('../../src/player/collision.js').SolidFn} */ solid,
