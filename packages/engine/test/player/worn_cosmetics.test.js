...
// by bench/_worn_live_capture.spec.js [retired, issue #74] on real hardware).

import { test, expect, describe, spyOn } from 'bun:test'
import { Bone, BoxGeometry, Group, Mesh, MeshStandardMaterial } from 'three'

import { compute_worn_head_scale, create_worn_cosmetics, HEAD_FIT } from '../../src/player/worn_cosmetics.js'
...
async function wait_for_mount(
  ...
  /** @type {import('../../src/player/worn_cosmetics.js').WornSlot} */ slot
) {
