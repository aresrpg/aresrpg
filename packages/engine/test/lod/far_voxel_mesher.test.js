...
import {
  ...
  voxel_mesh_bytes,
  FAR_VOXEL_MAX_LEVEL,
} from '../../src/lod/far_voxel_mesher.js'
import { build_far_mesh } from '../../src/lod/far_mesher.js'
import { CELLS_PER_SECTION, build_section, create_world_column_sampler } from '../../src/lod/section_builder.js'
 ...
 * @returns {import('../../src/lod/section_builder.js').Section}
 */
 ...
 *  @param {import('../../src/lod/far_voxel_mesher.js').VoxelMesh} m @param {(a:number,b:number,c:number)=>void} cb */
 ...
 *  @param {import('../../src/lod/far_voxel_mesher.js').VoxelMesh} m @param {number} v */
...
describe('build_far_mesh dispatch (progressive voxel doubling; ?farvoxel oracle override)', () => {
  ...
  test('a real generated L1 section meshes blocky under the oracle override (genuine colours + risers)', () => {
    ...
    const m = /** @type {import('../../src/lod/far_voxel_mesher.js').VoxelMesh} */ (mesh)
