...
import {
  build_far_mesh as build_far_mesh_any,
  far_mesh_bytes,
  CORNERS_PER_EDGE,
  SKY_SLAB_DEPTH,
} from '../../src/lod/far_mesher.js'
import {
  CELLS_PER_SECTION,
  LOD_MAX_LEVEL,
  build_section,
  create_world_column_sampler,
} from '../../src/lod/section_builder.js'
import { get_map_color } from '../../src/lod/colors.js'
...
/** @param {import('../../src/lod/section_builder.js').Section} s @returns {import('../../src/lod/far_mesher.js').FarMesh} */
const build_far_mesh = (s) => /** @type {import('../../src/lod/far_mesher.js').FarMesh} */ (build_far_mesh_any(s))
