...
import { create_mob_model as world_mob_visual_factory } from '@aresrpg/engine3/player'

import { create_mob_model as fight_mob_visual_factory } from '../player/mob_model.js'

import { create_board_entities, entity_outline_color } from './board_entities.js'
...
describe('real rabbit GLB — overworld/fight mob render parity', () => {
  ...
  test('the real board consumer matches an overworld factory instance and restores its flash baseline', async () => {
