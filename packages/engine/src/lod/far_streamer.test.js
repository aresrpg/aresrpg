...
} from './far_streamer.js'
import { CORNERS_PER_EDGE } from './far_mesher.js'
import { section_span_meters } from './quadtree.js'
 ...
 *  @returns {import('./far_mesher.js').FarMesh} */
 ...
 *  @returns {Promise<import('./far_mesher.js').FarMesh>} */
 ...
 * @returns {import('../render/far_field.js').FarField & { ids: () => string[] }}
 */
 ...
 *  @param {import('./far_streamer.js').FarStreamer} streamer
...
describe('far_streamer schedule', () => {
  ...
  test('boot burst: raises dispatch for the first frames, then trickles to the steady cap', async () => {
    const far_field = make_fake_far_field()
    /** @type {((v: import('./far_mesher.js').FarMesh) => void)[]} */
    const resolvers = []
