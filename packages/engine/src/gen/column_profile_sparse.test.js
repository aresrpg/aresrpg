 ...
 * @param {import('./column_gen.js').GenContext} dense_ctx
 * @param {import('./column_gen.js').GenContext} sparse_ctx
...
describe('sparse ≡ dense: fill_profile_column equals the build_column_profile grid entry', () => {
  /** @type {[string, import('../config/world_gen_config.js').WorldGenConfig | undefined][]} */
  const CASES = [
    ['default', undefined],
