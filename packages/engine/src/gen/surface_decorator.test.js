...
import { create_chunk_record, local_index, column_index } from '../chunks/format.js'
import { get_block_by_name } from '../config/block_registry.js'
import { mesh_chunk } from '../mesh/mesher.js'
import { decode_quad } from '../mesh/quad_buffer.js'
import { get_biome_by_name } from '../config/biome_registry.js'
import { DEFAULT_WORLD_GEN_CONFIG } from '../config/world_gen_config.js'

import { load_schematic, load_schematic_set, voxel_count } from './schematics/loader.js'
import { select_schematic, stamp_into_chunk } from './schematics/stamper.js'
import { create_gen_context, anchor_surface, build_column_profile, fill_chunk_from_profile } from './column_gen.js'
import { generate_world_chunk } from './world_gen.js'
import { BIOME_SCHEMATICS, filter_by_prefix, decorate_chunk, decoration_availability } from './surface_decorator.js'
import { surface_flora } from './surface_flora.js'
import { surface_moisture } from './surface_density.js'
...
/** @param {import('../chunks/format.js').ChunkRecord} c @returns {number} */
 ...
 * @param {import('../config/biome_registry.js').BiomeDef | undefined} biome
...
function decode_all({ quad_buffer, quad_count }) {
  /** @type {import('../mesh/quad_buffer.js').QuadFields[]} */
  const out = []
 ...
 *  @param {import('../config/world_gen_config.js').WorldGenConfig} config @param {number} cx @param {number} cz */
