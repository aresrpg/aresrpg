...
import { get_block_by_id, AIR_BLOCK_ID } from '../../config/block_registry.js'
import { for_each_voxel, voxel_count } from '../schematics/loader.js'

import { generate_tree, build_tree } from './tree_gen.js'
import { SPECIES, SPECIES_KEYS } from './species.js'
 ...
 *  @param {import('../schematics/loader.js').ResolvedSchematic} t */
...
describe('ResolvedSchematic contract (loader.js shape — placed by the existing stamper unchanged)', () => {
  test('shape: name/category/size[3]/anchor[3]/compact/reach/water_anchor (P0: flat typed-array carrier)', () => {
    ...
    const { compact } = /** @type {{ compact: import('../schematics/loader.js').CompactVoxels }} */ (t)
