...
import { FACE_BRIGHTNESS, SUN_LEAK_GATE, sun_direct_factor } from './terrain_material.js'
import { AO_LEVELS, ao_level_fraction } from './terrain_ao.js'
import { AXIS_FACE_TABLE, WINDING_FLIP_FACES, AO_VMIRROR_REMAP } from './terrain_winding.js'
 ...
 * @param {import('./terrain_winding.js').FaceAxes} axes
...
describe('FrontSide winding — flip set derived from the corner geometry', () => {
  ...
  test('the v-mirror preserves the four WORLD corners (no position drift — double-shift guard)', () => {
    ...
    /** @param {import('./terrain_winding.js').FaceAxes} axes @param {boolean} front_side */
