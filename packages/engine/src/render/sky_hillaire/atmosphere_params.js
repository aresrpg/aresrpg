...
export const EARTH_ATMOSPHERE = Object.freeze(
  /** @type {AtmosphereParams} */ ({
    ...
    mie_g: 0.8,
    mie_density_h: 1.2,
    ozone_absorption: [0.65e-3, 1.881e-3, 0.085e-3], // per-km (paper 0.650/1.881/0.085e-6/m)
 ...
 */
export function merge_atmosphere_params(base, over = {}) {
  return { ...base, ...over }
}
 ...
 * @returns {SkyTier}
 */
export function resolve_sky_tier(tier) {
 ...
 */
export function ozone_density(h_km, center_km, width_km) {
