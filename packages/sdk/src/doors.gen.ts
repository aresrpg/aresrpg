...
export const create_character = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ...
      tx.pure.string(args.raw_name),
      tx.pure.string(args.classe),
      tx.pure.bool(args.male),
      tx.pure.u32(args.color_1),
      tx.pure.u32(args.color_2),
      tx.pure.u32(args.color_3),
...
export const join_world = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ctx.obj(tx, args.kiosk, true),
      ctx.obj(tx, args.cap, false),
      tx.pure.id(args.character_id),
      tx.pure.string(args.world),
      ctx.pin(tx, 'version', false),
      tx.object.clock(),
    ],
  })
...
export const raise_stat = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ...
      ctx.obj(tx, args.cap, false),
      tx.pure.id(args.character_id),
      tx.pure.string(args.stat),
      tx.pure.u16(args.amount),
      ctx.pin(tx, 'version', false),
    ],
  })
...
export const equip_item = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ...
      ctx.obj(tx, args.cap, false),
      tx.pure.id(args.character_id),
      tx.pure.string(args.slot),
      tx.pure.id(args.item_id),
...
export const feed_kiosk_pet = (
  tx: Transaction,
  ctx: DoorCtx,
  args: { kiosk: Resolvable; cap: Resolvable; pet_id: string; food_id: string }
) =>
  tx.moveCall({
    ...
    arguments: [
      ctx.obj(tx, args.kiosk, true),
      ctx.obj(tx, args.cap, false),
      tx.pure.id(args.pet_id),
      tx.pure.id(args.food_id),
      ctx.pin(tx, 'item_protected_policy', false),
      ctx.pin(tx, 'version', false),
      tx.object.clock(),
    ],
...
export const engage_fight = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ...
      tx.pure.u32(args.zx),
      tx.pure.u32(args.zz),
      tx.pure.u64(args.group_index),
      tx.pure.u8(args.access),
      ctx.pin(tx, 'character_protected_policy', false),
      ctx.pin(tx, 'version', false),
      tx.object.clock(),
    ],
...
export const place_fighter = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ctx.obj(tx, args.f, true),
      tx.pure.u64(args.fighter_idx),
      tx.pure.u64(args.cell),
      ctx.pin(tx, 'version', false),
    ],
  })
...
export const ready_fighter = (
  ...
  tx.moveCall({
    ...
    arguments: [ctx.obj(tx, args.f, true), tx.pure.u64(args.fighter_idx), ctx.pin(tx, 'version', false)],
  })
...
export const move_fighter = (
  ...
  tx.moveCall({
    ...
    arguments: [ctx.obj(tx, args.f, true), tx.pure.vector('u64', args.path), ctx.pin(tx, 'version', false)],
  })
...
export const claim_fight_drop = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ...
      tx.pure.option('id', args.existing ?? null),
      ctx.obj(tx, args.kiosk, true),
      ctx.obj(tx, args.cap, false),
      ctx.pin(tx, 'item_policy', false),
      tx.object.random(),
...
export const party_invite = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ...
      ctx.obj(tx, args.kiosk, false),
      ctx.obj(tx, args.cap, false),
      tx.pure.id(args.leader_id),
      tx.pure.id(args.invited_character),
      ctx.pin(tx, 'version', false),
    ],
  })
...
export const party_kick = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ...
      ctx.obj(tx, args.cap, false),
      tx.pure.id(args.leader_id),
      tx.pure.id(args.target_character),
      ctx.pin(tx, 'version', false),
    ],
  })
...
export const gather = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ...
      tx.pure.u32(args.zx),
      tx.pure.u32(args.zz),
      tx.pure.u64(args.pack_index),
      ctx.obj(tx, args.template, false),
      ctx.obj(tx, args.rare_template, false),
      tx.pure.option('id', args.existing ?? null),
      tx.pure.option('id', args.existing_rare ?? null),
      ctx.pin(tx, 'item_policy', false),
      tx.object.random(),
      ctx.pin(tx, 'version', false),
      tx.object.clock(),
...
export const craft = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ...
      ctx.obj(tx, args.cap, false),
      tx.pure.id(args.character_id),
      tx.pure.vector('id', args.input_item_ids),
...
export const scribe_rune = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ...
      ctx.obj(tx, args.cap, false),
      tx.pure.id(args.character_id),
      tx.pure.id(args.gear_id),
      ctx.obj(tx, args.gear_template, false),
      tx.pure.id(args.rune_item_id),
      ctx.pin(tx, 'item_protected_policy', false),
      tx.object.random(),
      ctx.pin(tx, 'version', false),
    ],
...
export const crush_gear = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ctx.obj(tx, args.kiosk, true),
      ctx.obj(tx, args.cap, false),
      tx.pure.vector('id', args.gear_ids),
      ctx.pin(tx, 'item_protected_policy', false),
      tx.object.random(),
      ctx.pin(tx, 'version', false),
    ],
...
export const create_kolizeum = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ...
      tx.pure.u64(args.format),
      tx.pure.u16(args.level_min),
      tx.pure.u16(args.level_max),
      tx.pure.u8(args.access),
      ctx.pin(tx, 'character_protected_policy', false),
      ctx.obj(tx, args.kiosk, true),
      ctx.obj(tx, args.cap, false),
...
export const add_friend = (tx: Transaction, ctx: DoorCtx, args: { list: Resolvable; addr: string }) =>
  tx.moveCall({
    ...
    arguments: [ctx.obj(tx, args.list, true), tx.pure.address(args.addr), ctx.pin(tx, 'version', false)],
  })
...
export const trade_create = (tx: Transaction, ctx: DoorCtx, args: { counterparty: string }) =>
  tx.moveCall({
    ...
    arguments: [tx.pure.address(args.counterparty), ctx.pin(tx, 'version', false)],
  })
...
export const trade_withdraw_item_cap = (tx: Transaction, ctx: DoorCtx, args: { t: Resolvable; item: string }) =>
  tx.moveCall({
    ...
    arguments: [ctx.obj(tx, args.t, true), tx.pure.id(args.item), ctx.pin(tx, 'version', false)],
  })
...
export const trade_withdraw_sui = (
  ...
  tx.moveCall({
    ...
    arguments: [ctx.obj(tx, args.t, true), tx.pure.u64(args.amount), ctx.pin(tx, 'version', false)],
  })
...
export const trade_accept = (
  ...
  tx.moveCall({
    ...
    arguments: [ctx.obj(tx, args.t, true), tx.pure.u64(args.seen_version), ctx.pin(tx, 'version', false)],
  })
...
export const DOORS = {
  ...
  feed_kiosk_pet: { params: ['kiosk', 'cap', 'pet_id', 'food_id'], terminal: false },
