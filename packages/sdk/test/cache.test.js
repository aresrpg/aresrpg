...
import { create_cache, absorb_receipt, absorb_object, owned_ref, shared_ref } from '../src/cache.js'

const id = (n) => `0x${String(n).padStart(64, '0')}`
const owned = (object_id, version, digest) => ({
  objectId: object_id,
  idOperation: 'None',
...
const wrap = (rows) => ({ effects: { changedObjects: rows } })
