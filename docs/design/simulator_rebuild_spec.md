...
| --- | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| 1   | `packages/sim/src/reduce.js` (`@aresrpg/sim/reduce`)                                                               | `reduce`, `create_fight_state`; `spell_levels` keys are the castable set — the authority                                                                      | GENERIC                                                                      |
...
| 4   | `packages/sim/src/prng.js`, `turn_seed.js`                                                                         | seeded rng thread; turn-seed only for the spell-bar glow preview parity fields                                                                                | GENERIC                                                                      |
...
| 13  | `packages/fight/src/capsule.js`, `envelope.js`, `classify_input.js`, `core*.js`                                    | trace_format-2 capsules + the core replay of them                                                                                                             | GENERIC                                                                      |
...
| 20  | `packages/frontend/src/game/data/spell_corpus.js`                                                                  | `load_spell_corpus`/`get_spell_corpus` — the published chain spell corpus (asset-host blob, NOT a chain read)                                                 | GENERIC                                                                      |
| 21  | `packages/frontend/src/game/data/mob_catalog.js`                                                                   | mob GLB resolution (asset-host blob)                                                                                                                          | GENERIC                                                                      |
...
| `hand_update` (retired sim event)      | nothing emitted; the spell bar is seeded at open/focus from `spell_levels` keys (SpellTemplate `object_id`s)                                                                                                                                                                                                                                                                                          |
...
| -------------------------------------------------------- | -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| trace_format-2 envelope capsule                          | `packages/fight/src/capsule.js` (`capsule_export`) | the door tee (`fight_trace_tee.js`) → the SAME FightReport export button the game ships (`fight_trace_export.js`) | `packages/fight/src/core_replay.js` (`replay_trace`)                                                                                  |
