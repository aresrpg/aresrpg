...
export const Actions = { ADD: 0, REMOVE: 1, UPDATE_HEALTH: 2, UPDATE_TITLE: 3, UPDATE_STYLE: 4, UPDATE_FLAGS: 5 };
export const Colors = { PINK: 0, BLUE: 1, RED: 2, GREEN: 3, YELLOW: 4, PURPLE: 5, WHITE: 6 };
export const Divisions = { NO_DIVISION: 0, '6_NOTCHES': 1, '10_NOTCHES': 2, '12_NOTCHES': 3, '20_NOTCHES': 4 };
 ...
 */
export function write_bossbar(state, { action, title, health, color, dividers, flags }) {
