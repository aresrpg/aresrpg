...
import { trees } from '../modules/entity_behavior.js'

import { SUCCESS, FAILURE, RUNNING } from './entity_behavior.js'
...
function behavior({ world, app }) {
  ...
  const instances = world.mobs.map(({ entity_id }) => ({
    entity_id,
    current: {},
