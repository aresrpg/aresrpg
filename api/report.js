...
//  is stable, lighter, and — for THIS file specifically — the only choice correct in
//  BOTH of sponsor.mjs's runtimes: the Vercel Node serverless function (the default
//  export `handler`) AND the standalone Bun container (`Bun.serve` at the bottom of
//  sponsor.mjs). @sentry/bun's Bun.serve auto-instrumentation wouldn't even apply to
//  the Vercel path. See the PR description for the fuller comparison.
//
