...
// turn routing, the cross-visibility ledger, the EXACT Move xp_share twin, the per-seat split verdict, and
// the disconnect-crank stall budget. Every function is pure data-in → data-out (house FP constitution).
